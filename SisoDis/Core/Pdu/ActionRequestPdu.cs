...
/// <summary>
/// Represents DIS Action Request PDU (IEEE 1278.1-2012 §5.3.6.6).
/// </summary>
public record struct ActionRequestPdu(
    uint RequestId,
    ushort ActionId,
...
) : IPdu
{
    ...
    public static ActionRequestPdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
    ...
    public class Builder
    {
        ...
        public ActionRequestPdu Build() => new(
            _requestId,
            _actionId,
            _numberOfFixedDatum,
