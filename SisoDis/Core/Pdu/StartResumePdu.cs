...
/// <summary>
/// Represents DIS Start/Resume PDU (IEEE 1278.1-2012 §5.3.6.3).
/// </summary>
public record struct StartResumePdu(
    uint RequestId,
    uint RealTime,
    uint SimulationTime,
    byte Level,
...
) : IPdu
{
    ...
    public static StartResumePdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
