...
public record struct BreakoutRequestPdu(
    EntityId RequestingEntityId,
    uint RequestId,
    ushort NumberOfRequestedUnits,
...
) : IPdu
{
    ...
    public void SerializeBody(Span<byte> buffer, int offset)
    {
        ...
        BinaryPrimitives.WriteUInt16BigEndian(buffer.Slice(offset, 2), NumberOfRequestedUnits);
        offset += 2;
    ...
    public static BreakoutRequestPdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
        ...
        ushort numberOfRequestedUnits = BinaryPrimitives.ReadUInt16BigEndian(buffer.Slice(pos, 2));
        pos += 2;
        ...
        return new BreakoutRequestPdu(
            requestingEntityId,
            requestId,
            numberOfRequestedUnits,
            numberOfFixedDatum,
    ...
    public class Builder
    {
        ...
        private ushort _numberOfRequestedUnits = 0;
        ...
        public Builder WithNumberOfRequestedUnits(ushort count) { _numberOfRequestedUnits = count; return this; }
        ...
        public BreakoutRequestPdu Build() => new(
            _requestingEntityId,
            _requestId,
            _numberOfRequestedUnits,
            _numberOfFixedDatum,
