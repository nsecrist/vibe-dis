...
public record struct BreakoutCancelPdu(
...
) : IPdu
{
    ...
    public static BreakoutCancelPdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
    ...
    public class Builder
    {
        ...
        public BreakoutCancelPdu Build() => new(
            _requestingEntityId,
            _requestId,
            _numberOfFixedDatum,
