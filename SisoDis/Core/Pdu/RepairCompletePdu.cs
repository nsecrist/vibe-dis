...
public record struct RepairCompletePdu(
...
{
    public const ushort PdTypeValue = 45;
    ...
    public static RepairCompletePdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
    ...
    public class Builder
    {
        ...
        public RepairCompletePdu Build() => new(
            _receivingEntityId,
            _repairType,
            _requestId,
            _numberOfFixedDatum,
