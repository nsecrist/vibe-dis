...
public record struct ResupplyReceivedPdu(
...
) : IPdu
{
    ...
    public static ResupplyReceivedPdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
    ...
    public class Builder
    {
        ...
        public ResupplyReceivedPdu Build() => new(
            _receivingEntityId,
            _supplyType,
            _quantity,
            _requestId,
