...
/// <summary>
/// Represents DIS Remove Entity PDU (IEEE 1278.1-2012 §5.3.6.2).
/// </summary>
public record struct RemoveEntityPdu(
    uint RequestId,
    byte NumberOfParts,
    byte Padding,
    EntityId EntityId,
...
) : IPdu
{
    ...
    public static RemoveEntityPdu Deserialize(ReadOnlySpan<byte> buffer, int offset = 0)
    {
    ...
    public class Builder
    {
        ...
        public RemoveEntityPdu Build() => new(
            _requestId,
            _numberOfParts,
            _padding,
            _entityId,
